...
Packet compression is negotiated at login with a 256-byte threshold. Wire and decompressed packet sizes and inbound rates are bounded; see [OPERATIONS.md](OPERATIONS.md). This does not provide authentication or encryption.
